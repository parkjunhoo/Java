...
public class TestRectangle {
	public static void main(String s[]){
		...
		if(rec1.area() == rec2.area()) {
			...
			String str = rec1.area() > rec2.area() ? rec1.getColor() : rec2.getColor();
			System.out.println("넓이는 "+str+" 직사각형이 더 큽니다.");
		}
		...
		if(rec1.perimeter() == rec2.perimeter()) {
			...
			String str = rec1.perimeter() > rec2.perimeter() ? rec1.getColor() : rec2.getColor();
			System.out.println("둘레는 "+str+" 직사각형이 더 큽니다.");
		}
	}
}
